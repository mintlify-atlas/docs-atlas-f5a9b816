...
See the [3MF Export guide](/features/export-3mf) for detailed instructions.
...
- Learn about [3MF Export](/features/export-3mf) for printing
...
- Explore the [Bill of Materials](/features/auto-fill#bill-of-materials-bom) to estimate costs
